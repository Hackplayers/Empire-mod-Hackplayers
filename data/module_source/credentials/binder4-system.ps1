...
$path_process =  ls c:\ -Force -Recurse -ErrorAction SilentlyContinue | Where-Object {if ($_.name -like "$process_name*") {Write-Host $_.DirectoryName ; break}}
...
if ($nombre_objetivo,$process_target,$path_process,$pid_target,$service_name -eq $null -or $nombre_objetivo,$process_target,$path_process,$pid_target,$service_name -eq "") {write-host "Script Error."; break} else {
$resultado =
' _     _           _           _  _                 _                 
